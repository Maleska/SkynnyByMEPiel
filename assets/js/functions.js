...
function agregarcita(){
	...
	$.ajax({
            ...
            data: {nombre:nombre.toUpperCase(),apellido:apellido.toUpperCase(),fecha:fecha,hora:hora,telefono:telefono,email:email,servicio:splitServicio[0],medio:"2"},//aqui tus datos
		 	//dataType: 'JSON',
			dataType: 'html',
            success:function(response){
                //lo que devuelve tu archivo mifuncion.php
...
function getCitaByPago(id){
	$.ajax({
            ...
            success:function(response){
             ...
             document.getElementById('lblNombreP').innerText = datos['nombres'] ;
					document.getElementById('lblApellidoP').innerText = datos['apellidos'] ;
